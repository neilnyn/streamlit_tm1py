...
def create_drag_interface(conn:'Psql Connection'):
    ...
    with col1:
        ...
        table_name = st.selectbox("选择维表",["product_dimension", "store_dimension", "time_dimension"])
...
def main():
    # PostgreSQL连接
    with psycopg2.connect(database="sales", user="postgres", password="1234", host="localhost", port="5432") as conn:
